...
|---------|------|-------------|
| `packages/core/` | `@roci/core` | Domain-agnostic engine: types, phase system, the `brain/` cognition stack (`brain/stem` tick engine, limbic + cortex layers, shared transport), operating skills, long-term memory, services (Docker, Claude, CharacterFs, OAuthToken, ProjectRoot), logging |
...
See [HARNESS.md](HARNESS.md) for detailed architecture documentation covering the `brain/stem` tick engine, phase system, limbic subsystems, and operating skills.
