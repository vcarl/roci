...
import { MemoryGateway, orientQuery } from "./memory-gateway.js"
import { readWm, renderOpenTodoTree } from "./wm-store.js"
 ...
 *     orient prompt (skills/orient.md); the idle path threads the same recall/wm
 *     onward into the conscious decide prompt (skills/decide.md). Assembled ONCE
